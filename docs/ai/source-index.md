...
| Landing page contract | `index.html` | 2026-06-20 | 2026-09-20 | Guess-name form, hero media, static asset, or frontend submission behavior changes | The page contains the visible campaign experience and a guess-name dialog with `guessName` and `email` fields. |
